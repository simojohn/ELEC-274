...
LOOP:
	...
	ldbu	r2, 0(r5)		# load first element in list into r4
	call	PrintHexByte	# print current element
	movi	r2, ')'
	call	PrintChar		# Call to print ')'
	movi	r2, ' '
	call	PrintChar		# Call to print blank space between brackets
